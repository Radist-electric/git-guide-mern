...
export const GitPage = () => {
  ...
  return (
    <Grid container>
      <Grid item xs={12}>
        <Typography variant="h1" component="h1">Что такое Git?</Typography>
      </Grid>
      <Grid item xs={12}>
        <Typography variant="body1" component="p">Git - это система контроля версий для программного продукта. Несколько программистов могут работать над одним проектом. Каждый локально выполняет свою задачу, а затем может поделиться своим кодом через эту систему или скачать себе чужой код. В том числе можно выполнить слияние кода, если работа велась над одной и той же частью программы. Создавая периодически точки сохранения, можно в любой момент вернуться к другой версии вашей программы. Хранилищем вашего проекта является репозиторий.</Typography>
        <Typography variant="body1" component="p">Для управления Git-репозиториями существуют различные платформы. Например, те, которые у большинства на слуху - это GitHub и GitLab.</Typography>
        <Typography variant="h2" component="h2">Основные термины</Typography>
      </Grid>
      <div className={classes.root}>
        {data}
      </div>
      <Grid item xs={12}>
        <Typography variant="h2" component="h2">Базовые шаги работы с Git</Typography>
      </Grid>
